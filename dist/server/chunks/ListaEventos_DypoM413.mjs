...
const $$ListaEventos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<ul class="space-y-4"> <li class="text-slider-nav font-normal">No hay elementos.</li> <li class="p-4 bg-white shadow rounded-lg flex items-center justify-between"> <div> <h3 class="text-lg font-medium">titulo evento</h3> <p class="text-gray-500">description</p> <time class="text-sm text-gray-400">
