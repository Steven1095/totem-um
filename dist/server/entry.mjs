...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_DPQywcmC.mjs';
...
const _page1 = () => import('./pages/api/ticketmaster.json.astro.mjs');
const _page2 = () => import('./pages/api.astro.mjs');
const _page3 = () => import('./pages/components/buscador.astro.mjs');
const _page4 = () => import('./pages/components/buscador2.astro.mjs');
const _page5 = () => import('./pages/components/layouts/mainlayouts.astro.mjs');
const _page6 = () => import('./pages/components/panel.astro.mjs');
const _page7 = () => import('./pages/components/slider.astro.mjs');
const _page8 = () => import('./pages/dependencias/_name_.astro.mjs');
const _page9 = () => import('./pages/dependencias.astro.mjs');
const _page10 = () => import('./pages/eventos/_name_.astro.mjs');
const _page11 = () => import('./pages/eventos.astro.mjs');
const _page12 = () => import('./pages/eventos2/_name_.astro.mjs');
const _page13 = () => import('./pages/eventos2.astro.mjs');
const _page14 = () => import('./pages/sliderdata.astro.mjs');
const _page15 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/node.js", _page0],
    ["src/pages/api/ticketmaster.json.ts", _page1],
    ["src/pages/api.astro", _page2],
    ["src/pages/components/Buscador.astro", _page3],
    ["src/pages/components/Buscador2.astro", _page4],
    ["src/pages/components/Layouts/MainLayouts.astro", _page5],
    ["src/pages/components/Panel.astro", _page6],
    ["src/pages/components/Slider.astro", _page7],
    ["src/pages/dependencias/[name].astro", _page8],
    ["src/pages/dependencias.astro", _page9],
    ["src/pages/eventos/[name].astro", _page10],
    ["src/pages/eventos.astro", _page11],
    ["src/pages/eventos2/[name].astro", _page12],
    ["src/pages/eventos2.astro", _page13],
    ["src/pages/SliderData.astro", _page14],
