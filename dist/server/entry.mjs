...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_Pk46Buz5.mjs';
...
const _page4 = () => import('./pages/components/layouts/mainlayouts.astro.mjs');
const _page5 = () => import('./pages/components/panel.astro.mjs');
const _page6 = () => import('./pages/components/slider.astro.mjs');
const _page7 = () => import('./pages/components/sliderdata.astro.mjs');
const _page8 = () => import('./pages/dependencias.astro.mjs');
const _page9 = () => import('./pages/eventos/_name_.astro.mjs');
const _page10 = () => import('./pages/eventos.astro.mjs');
const _page11 = () => import('./pages/events/_name_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/components/Layouts/MainLayouts.astro", _page4],
    ["src/pages/components/Panel.astro", _page5],
    ["src/pages/components/Slider.astro", _page6],
    ["src/pages/components/SliderData.astro", _page7],
    ["src/pages/dependencias.astro", _page8],
    ["src/pages/eventos/[name].astro", _page9],
    ["src/pages/eventos.astro", _page10],
    ["src/pages/events/[name].astro", _page11],
